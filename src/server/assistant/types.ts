...
export const VALID_INTENTS: IntentType[] = [
    ...
    'RESEARCH_SEARCH', 'EXACT_DATASET_RESEARCH',
...
/** Intents that require external dataset/model/research search API calls */
export const SEARCH_INTENTS: IntentType[] = [
    'DATASET_SEARCH', 'MODEL_SEARCH', 'PROJECT_ANALYSIS', 'RESEARCH_SEARCH', 'EXACT_DATASET_RESEARCH', 'HYBRID', 'DATASET_MODEL_MATCHING'
];
...
export interface AssistantResponse {
    type: 'general' | 'dataset' | 'hybrid' | 'model' | 'project' | 'comparison' | 'greeting' | 'research';
    answer?: string;

    // Dataset & Model & Research fields
    analysis?: any;
    summary?: any;
    hardware?: any;
    feasibility?: any;
